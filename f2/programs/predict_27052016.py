...
sample = load_csv("sample2.csv")

print sample.dtypes

sample['id'].astype(int)
sample['age'] = 2016 - sample['annee_naissance']
sample['duree_permis'] = 2015 - sample['annee_permis']
...
sample_X = sample_mapper[0:300000, 1:31+2+1+1]
sample_y = sample_mapper[0:300000, 31+2+1+1]
sample_t = sample_mapper[300000:330000, 1:31+2+1+1]
