...
def build_sample(regressor, name):
	...
	# predict on test
	predict_res = regressor.predict(sample_t)
...
sample_X = sample_mapper[0:300000, 1:31-14]
sample_y = sample_mapper[0:300000, 31-14]
sample_t = sample_mapper[300000:330000, 1:31-14]
